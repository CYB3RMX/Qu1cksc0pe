...
{cy} \\_/\\_|\\___/ \\___/\\____/\\_| \\_/\\____/ \\____/\\___/\\_|   \\____/       {gr}@ @ @
                                                                      @
                                   {ye}|             |
  {wh}All in One malware analysis tool.{ye}| {wh}By CYB3RMX_ {ye}| {wh}Version: {gr}1.8.6
  {ye}---------------------------------|             |{wh}\n
"""
banner2=f"""
        {ma}:ooooo/        /ooooo:
  ...
  {ma}NMM-  sMMyvvvvvvvvvvvvvvsMMy  .MMM   {wh}|             {gr}Version{wh}: {ye}1.8.6              {wh}|
...
+ --------------I I------------- +
                ...
                {ye}I I
             ____V_____              {ma}Version: {re}1.8.6{wh}\n\n
"""
banner5=f"""
                        {re}* -------------------------------- *
