...
banner()
{
  ...
  echo -en "                                                                       @ \n"
  echo -en "                                        ${ye}|             | \n"
  echo -en "   ${wh}Suspicious file static-analysis tool.${ye}| ${wh}By CYB3RMX_${ye} | ${wh}Version: ${gr}1.6.9 \n"
  echo -en "   ${ye}-------------------------------------|             |${wh} \n\n"
}
banner1()
{
  ...
  echo -en "$ma  NMM-  sMMyvvvvvvvvvvvvvvsMMy  .MMM   $wh|       ${gr}Version$wh:$ye 1.6.9         $wh|\n"
...
banner4()
{
  ...
  echo -en "                ${ye}I I \n"
  echo -en "             ____V_____              ${gr}Version:$re 1.6.9$wh\n\n\n"
}
banner5()
{
  echo -en "                        ${re}* -------------------------------- *\n"
